...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `employee_name` varchar(255) NOT NULL COMMENT 'user name',
  `email` NOT NULL COMMENT 'email',
  `phone` int(11) NOT NULL COMMENT 'phone',
  PRIMARY KEY (`id`)
...
INSERT INTO `user` (`id`, `user_name`, `email`, `phone`) VALUES
